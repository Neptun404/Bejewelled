...
function toggleMenu() {
    ...
    const openNav = "0rem", closeNav = "-17rem";
    mobileNav.style.left = isOpened ? closeNav : openNav;
    const navClosed = "header__mobile-menu--closed", navOpened = "header__mobile-menu--opened";
    mobileNav.classList.replace(isOpened ? navOpened : navClosed, isOpened ? navClosed : navOpened);
    isOpened = !isOpened;
    // Disable scrolling
